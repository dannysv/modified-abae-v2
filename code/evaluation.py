...
###### Get test data #############
vocab, train_x, test_x, ref_x, overall_maxlen = dataset.get_data_totest(args.domain, vocab_size=args.vocab_size, maxlen=args.maxlen)
test_x = sequence.pad_sequences(test_x, maxlen=overall_maxlen)
ref_x = sequence.pad_sequences(ref_x, maxlen=overall_maxlen)
...
test_fn = K.function([model.get_layer('sentence_input').input, model.get_layer('refwords_input').input, K.learning_phase()], 
        [model.get_layer('att_weights').output, model.get_layer('p_t').output])
att_weights, aspect_probs = test_fn([test_x, ref_x, 0])
...
##:----> cluster map para PLUS
# map for the pre-trained restaurant model (under pre_trained_model/restaurant)
#cluster_map = {0: 'Food', 1: 'Ambience', 2: 'Staff', 3: 'Miscellaneous',
#               4: 'Ambience', 5: 'Food', 6:'Anecdotes',  7: 'Ambience', 8: 'Food', 
#               9: 'Food', 10: 'Price', 11: 'Staff', 
#               12: 'Staff', 13: 'Miscellaneous'}

# Food, ambience, staff, price, anecdotes, misc


##----> cluster map para NORMAL

##----> cluster map para 3 (staff, ambience, food)
cluster_map = {0: 'Food', 1: 'Miscellaneous', 2: 'Anecdotes', 3: 'Staff',
               4: 'Ambience', 5: 'Food', 6:'Price',  7: 'Ambience', 8: 'Anecdotes', 
               9: 'Food', 10: 'Price', 11: 'Food', 
               12: 'Staff', 13: 'Food'}
