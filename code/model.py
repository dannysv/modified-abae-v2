...
def create_model(args, maxlen, vocab):
    ...
    #additional input
    refwords_input = Input(shape=(maxlen,), dtype='int32', name='refwords_input')
    ...
    if args.emb_path:
        ...
        K.set_value(model.get_layer('word_emb').W, emb_reader.get_emb_matrix_given_vocab(vocab, K.get_value(model.get_layer('word_emb').W)))
